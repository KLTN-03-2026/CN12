<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QuanLyKhoanThu.aspx.cs" Inherits="QuanLyTaiChinh.QuanLyKhoanThu" %>
...
<div class="income-page">
    <div class="income-card">
        ...
        <div class="income-header">
            <div class="income-title">Quản lý khoản thu</div>

            <div class="total-money">
                Tổng khoản thu:
                <asp:Label ID="lblTongKhoanThu" runat="server" Text="0 VNĐ"></asp:Label>
            </div>

            <asp:Button ID="btnThemKhoanThu" runat="server"
                Text="Thêm khoản thu"
                CssClass="btn-add"
                OnClick="btnThemKhoanThu_Click" />
        </div>
        ...
        <div class="table-box">
            <asp:GridView ID="gvKhoanThu" runat="server"
                AutoGenerateColumns="False"
                CssClass="income-grid"
                GridLines="None"
                AllowPaging="True"
                PageSize="8"
                OnPageIndexChanging="gvKhoanThu_PageIndexChanging"
                OnRowCommand="gvKhoanThu_RowCommand">

                <Columns>
                    <asp:TemplateField HeaderText="STT">
                        <ItemTemplate>
                            <span class="stt">
<%# Container.DataItemIndex + 1 + (gvKhoanThu.PageIndex * gvKhoanThu.PageSize) %>
                            </span>
                        </ItemTemplate>
                    </asp:TemplateField>

                    <asp:BoundField DataField="TenKhoanThu" HeaderText="Tên" />

                    <asp:BoundField DataField="SoTien" HeaderText="Số tiền"
                        DataFormatString="{0:+#,##0 VNĐ}" />

                    <asp:BoundField DataField="TenDanhMucThu" HeaderText="Danh mục" />

                    <asp:BoundField DataField="NgayThu" HeaderText="Ngày"
                    ...
                    <asp:TemplateField HeaderText="Hành động">
                        <ItemTemplate>
                            <asp:Button ID="btnSua" runat="server"
                                Text="Sửa"
                                CssClass="btn-edit"
                                CommandName="SuaKhoanThu"
                                CommandArgument='<%# Eval("MaKhoanThu") %>' />

                            <asp:Button ID="btnXoa" runat="server"
                                Text="Xóa"
                                CssClass="btn-delete"
                                CommandName="XoaKhoanThu"
                                CommandArgument='<%# Eval("MaKhoanThu") %>' />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
...
<asp:Panel ID="pnlPopupThem" runat="server" CssClass="popup-overlay" Visible="false">
    <div class="popup-box">
        <div class="popup-title">Thêm khoản thu</div>

        <asp:Label ID="lblLoiThem" runat="server" CssClass="message-error"></asp:Label>

        <asp:Label runat="server" Text="Tên khoản thu" CssClass="popup-label"></asp:Label>
        <asp:TextBox ID="txtTenKhoanThuThem" runat="server" CssClass="popup-input"></asp:TextBox>
        ...
        <div class="popup-button-box">
            <asp:Button ID="btnLuuThem" runat="server"
                Text="Lưu"
                CssClass="btn-save"
                OnClick="btnLuuThem_Click" />

            <asp:Button ID="btnHuyThem" runat="server"
                Text="Hủy"
                CssClass="btn-cancel"
                OnClick="btnHuyThem_Click" />
        </div>
    </div>
</asp:Panel>
...
<asp:Panel ID="pnlPopupSua" runat="server" CssClass="popup-overlay" Visible="false">
    <div class="popup-box">
        <div class="popup-title">Sửa khoản thu</div>

        <asp:HiddenField ID="hfMaKhoanThuSua" runat="server" />
        <asp:Label ID="lblLoiSua" runat="server" CssClass="message-error"></asp:Label>

        <asp:Label runat="server" Text="Tên khoản thu" CssClass="popup-label"></asp:Label>
        <asp:TextBox ID="txtTenKhoanThuSua" runat="server" CssClass="popup-input"></asp:TextBox>
        ...
        <div class="popup-button-box">
            <asp:Button ID="btnLuuSua" runat="server"
                Text="Lưu"
                CssClass="btn-save"
                OnClick="btnLuuSua_Click" />

            <asp:Button ID="btnHuySua" runat="server"
                Text="Hủy"
                CssClass="btn-cancel"
                OnClick="btnHuySua_Click" />
        </div>
    </div>
</asp:Panel>
...
<asp:Panel ID="pnlPopupXoa" runat="server" CssClass="popup-overlay" Visible="false">
    <div class="delete-box">
        ...
        <asp:HiddenField ID="hfMaKhoanThuXoa" runat="server" />

        <div class="delete-message">
            Bạn có chắc muốn xóa khoản thu<br />
            “<asp:Label ID="lblTenKhoanThuXoa" runat="server"></asp:Label>
